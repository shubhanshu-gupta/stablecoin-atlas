...
const RESOURCES: Resource[] = [
    // Stage 1
    { id: 's1-1', stage: 1, title: 'What Are Stablecoins and How Do They Work?', type: 'Article', source: 'CoinDesk Learn', url: 'https://www.coindesk.com/learn/what-is-a-stablecoin/', readTime: '8 min read', description: 'The definitive beginner introduction to stablecoins.' },
    ...
    { id: 's1-4', stage: 1, title: 'State of Crypto Report', type: 'Article', source: 'a16z Crypto', url: 'https://a16zcrypto.com/posts/article/state-of-crypto-report-2024/', readTime: '5 min read', description: 'The big-picture case for stablecoins in the global financial system.' },
    ...
    // Stage 2
    { id: 's2-1', stage: 2, title: 'Visa Crypto Solutions', type: 'Report', source: 'Visa Research', url: 'https://usa.visa.com/solutions/crypto.html', readTime: '5 min read', description: 'Visa\'s crypto products and blockchain networks strategy.' },
    ...
    { id: 's2-3', stage: 2, title: 'Ledger Insights: Stablecoin News', type: 'Article', source: 'Ledger Insights', url: 'https://www.ledgerinsights.com/', readTime: '5 min read', description: 'Enterprise blockchain news including EU crypto regulation and what it means for issuers.' },
    ...
    { id: 's2-7', stage: 2, title: 'PayPal PYUSD: What It Is and How It Works', type: 'Article', source: 'CoinDesk', url: 'https://www.coindesk.com/learn/what-is-paypals-stablecoin-pyusd/', readTime: '7 min read', description: 'The story behind the flagship corporate stablecoin from PayPal.' },
    ...
    { id: 's2-11', stage: 2, title: 'Bankless Podcast Channel', type: 'Podcast', source: 'Bankless', url: 'https://www.youtube.com/@Bankless', readTime: 'Ongoing', description: 'Nuanced conversations on the stablecoin landscape with top guests.' },
    ...
    { id: 's4-11', stage: 4, title: 'Bankless: Videos', type: 'Podcast', source: 'Bankless', url: 'https://www.youtube.com/@Bankless', readTime: 'Ongoing', description: 'Expert roundtable on MiCA, MAS, and the future of compliant stablecoins.' },
